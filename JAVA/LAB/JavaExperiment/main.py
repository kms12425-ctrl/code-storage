...
# original_score_excel_file = submit_root_dir + r'JAVA 语言程序设计实验(19级实验课综合记载单).xlsx'
original_score_excel_file = submit_root_dir + r'JAVA 语言程序设计实验.xlsx'

# 自动测试结果记载单，可以事先不存在
# test_score_excel_file = submit_root_dir + r'JAVA 语言程序设计(18级综合记载单最新)-实验测试结果.xlsx'
test_score_excel_file = submit_root_dir + r'JAVA 语言程序设计实验-实验测试结果.xlsx'
